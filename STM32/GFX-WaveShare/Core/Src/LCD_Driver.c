...
* | Info        :   Basic version
*
* Скопировано ДОСЛОВНО из официального пакета Waveshare
* (3.5inch_TFT_Touch_Shield_Code_V2/STM32/XNUCLEO-F103RB/lcd3in5-demo/User/LCD/LCD_Driver.c),
* без единого изменения логики — включая ТОЧНУЮ CS-семантику (CS дёргается на
* каждый отдельный LCD_WriteReg/LCD_WriteData, а не держится низким на всю
* операцию). См. журнал GFX-WaveShare-Workflow.md, п. 6.18. Единственное, что
* адаптировано под нашу плату — низкоуровневые макросы/функции в DEV_Config.*
******************************************************************************/
