...
* (3.5inch_TFT_Touch_Shield_Code_V2/STM32/XNUCLEO-F103RB/lcd3in5-demo/User/LCD/LCD_Driver.h),
* без единого изменения логики — см. журнал GFX-WaveShare-Workflow.md, п. 6.18.
******************************************************************************/
